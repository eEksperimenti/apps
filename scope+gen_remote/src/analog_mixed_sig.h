...
#define ANALOG_MIXED_SIG_SIZE 0x000FFFFF

#define RP_AMS_AIN0 0
#define RP_AMS_AIN1 1
#define RP_AMS_AIN2 2
#define RP_AMS_AIN3 3

#define DIVISON_FACTOR 3500
...
void rp_ams_ApinGetValue( int obj_offset, float *value );
